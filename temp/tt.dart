...
//part '../lib/temp/app_store.g.dart';
...
abstract class _AppStore with Store {
  ...
  @action
  Future<void> setUserFullName(String val,
      {bool isInitializing = false}) async {
    userFullName = val;
    if (!isInitializing) await setValue(USER_FULL_NAME, val);
  }
  ...
  @action
  Future<void> setIndicatif(int val, {bool isInitializing = false}) async {
    indicatif = val;
    if (!isInitializing) await setValue(COUNTRY_INDICATIF, val);
  }
